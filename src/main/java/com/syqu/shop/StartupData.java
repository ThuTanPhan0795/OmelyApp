...
public class StartupData implements CommandLineRunner {
    ...
    private void exampleProduct_1(int price){
    ...
    private void exampleProduct_2(int price){
        final String NAME = "Jean jacket";
        final String IMAGE_URL = "https://github.com/ThuTanPhan0795/OmelyApp/blob/master/src/main/resources/static/img/products/man-4.jpg?raw=true";
        final String DESCRIPTION = "A powerful blender for smoothies and shakes.";
        final BigDecimal PRICE = BigDecimal.valueOf(price);
    ...
    private void exampleProduct_3(int price){
        final String NAME = "crew neck sweater";
        final String IMAGE_URL = "https://github.com/ThuTanPhan0795/OmelyApp/blob/master/src/main/resources/static/img/products/product-6.jpg?raw=true";
        final String DESCRIPTION = "A powerful blender for smoothies and shakes.";
        final BigDecimal PRICE = BigDecimal.valueOf(price);
